...
//     if (updatedData.position === 'GK') {
//         updatedData.diving = parseInt(document.getElementById('goalkeeperDiving').value, 10);
//         updatedData.handling = parseInt(document.getElementById('goalkeeperHandling').value, 10);
//         updatedData.kicking = parseInt(document.getElementById('goalkeeperKicking').value, 10);
//         updatedData.reflexes = parseInt(document.getElementById('goalkeeperReflexes').value, 10);
//         updatedData.speed = parseInt(document.getElementById('goalkeeperSpeed').value, 10);
//         updatedData.positioning = parseInt(document.getElementById('goalkeeperPositioning').value, 10);
//     } else {
//         updatedData.pace = parseInt(document.getElementById('updatePlayerPace').value, 10);
//         updatedData.shooting = parseInt(document.getElementById('updatePlayerShooting').value, 10);
//         updatedData.passing = parseInt(document.getElementById('updatePlayerPassing').value, 10);
//         updatedData.dribbling = parseInt(document.getElementById('updatePlayerDribbling').value, 10);
//         updatedData.defending = parseInt(document.getElementById('updatePlayerDefending').value, 10);
//         updatedData.physical = parseInt(document.getElementById('updatePlayerPhysical').value, 10);
//     }
...
//     const currentSection = document.querySelector('.gk-update:not(.hidden)') ? '.gk-update' : '.normal-update';
//     const isGoalkeeper = currentSection === '.gk-update';
    
//     // Get common data
//     const updatedPlayer = {
//         name: playerName,
//         position: document.querySelector(`${currentSection} #updatePlayerPosition`).value,
//         club: document.querySelector(`${currentSection} #updatePlayerClub`).value,
//         logo: document.querySelector(`${currentSection} #updateTeamSelectFlag`).value,
//         // Preserve other data
